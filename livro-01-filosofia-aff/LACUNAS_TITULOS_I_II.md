# Lacunas editoriais — Títulos I e II

## Critério utilizado

Uma lista de títulos, um resumo ou a afirmação de que um artigo foi redigido não substitui o texto integral. As lacunas abaixo registram aquilo que não foi efetivamente localizado nas fontes disponíveis.
...
O repositório ainda não contém o texto integral historicamente atribuído à Carta Magna de 40 artigos. A prioridade editorial não é reinventar artigos já aprovados, mas recuperar os originais. Somente após busca documental suficiente os textos ausentes deverão ser reconstruídos com base nos títulos, definições oficiais e regras editoriais existentes.
